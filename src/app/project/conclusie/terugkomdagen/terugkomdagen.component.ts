...
@Component({
  selector: 'app-terugkomdagen',
  templateUrl: './terugkomdagen.component.html',
  styleUrls: ['./terugkomdagen.component.css']
})
export class TerugkomdagenComponent implements OnInit {
    image;
    modal;
    modalImg;
    captionText;
